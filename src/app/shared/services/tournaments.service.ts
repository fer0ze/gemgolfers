...
export class TournamentsService {
  ...
  public getTournamentsListByClub(endDate: Date, clubId: string): Promise<any> {
    return new Promise((resolve) => {
      this.apollo
        .subscribe({
  ...
  public getClubDashboardStats(endDate: string, clubId: string): Promise<any> {
    return new Promise((resolve) => {
      this.apollo
        .subscribe({
  ...
  public setScoreUpdateTime(tournamentId: string, date: string): Promise<any> {
    return new Promise((resolve) => {
      this.apollo
        .mutate<any>({
