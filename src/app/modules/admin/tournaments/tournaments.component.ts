...
export class TournamentsComponent implements OnInit {
  ...
  async getTournamentLive() {
    ...
    let activeTournaments = dataTournamentsLive.ActiveTournaments;
    this.dataSourceUpComing = new MatTableDataSource(activeTournaments);
    //console.log("change source");
  ...
  async getTournamentIncompelete() {
    ...
    this.dataSourceIncomplete = new MatTableDataSource(
      dataTournamentsLive.Scheduled
    );
    //console.log("change source");
    this.dataSourceIncomplete.paginator = this.paginator;
    this.dataSourceIncomplete.sort = this.sort;
    this.isLoadingSchedule = false;
  }
  ...
  async getTournamentLiveForAdmin() {
    ...
    let dataTournamentsForLive =
      await this.facadeService.getTournamentsListForLiveByAdmin(todayDate);
    console.log(dataTournamentsForLive);

    let activeTournaments = dataTournamentsForLive.ActiveTournaments;
    this.dataSourceUpComing = new MatTableDataSource(activeTournaments);
    //console.log("change source");
    this.dataSourceUpComing.paginator = this.paginator;
    this.dataSourceUpComing.sort = this.sort;
  ...
  async getTournamentScheduleForAdmin() {
    ...
    let dataTournamentsForSchedule =
      await this.facadeService.getTournamentsListForSheduleByAdmin(todayDate);
  ...
  async getTournamentIncompeleteForAdmin() {
    ...
    this.dataSourceIncomplete = new MatTableDataSource(
      dataTournamentsForIncomplete.Scheduled
    );
    //console.log("change source");
    this.dataSourceIncomplete.paginator = this.paginator;
    this.dataSourceIncomplete.sort = this.sort;
